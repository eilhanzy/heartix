...
void syscallRegisterAll()
{
	...
	_syscallRegister(G_SYSCALL_EXECVE, (g_syscall_handler) syscallExecve, true);
	...
	_syscallRegister(G_SYSCALL_READ_LOG_HISTORY, (g_syscall_handler) syscallReadLogHistory);
